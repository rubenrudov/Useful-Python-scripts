...
class DataTypesHandler:
    ...
    def print_data_recursively(data, tab: str = "", print_dict: int = PRINT_ARROWS):
        ...
        # handle dictionaries
            ...
            if print_dict == DataTypesHandler.PRINT_BRACKETS:
                print(tab + "{")
            elif print_dict == DataTypesHandler.PRINT_DICT:
                print(tab + "%s {" % str(type(data)).split("'")[1])
            elif print_dict == DataTypesHandler.PRINT_ARROWS:
                print(tab + "%s {" % type(data))
            elif print_dict == PrintForm.NO_PRINT:
                return
            else:
                print(tab + "%s {" % type(data))
